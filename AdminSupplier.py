...
class Supplier:
    def __init__(self, admin_supplier_page):
        ...
        admin_supplier_page.resizable(0, 0)
        ...
        # Create label frame
        search_frame = LabelFrame(admin_supplier_page, text="Search Supplier Name", font=("Poppins SemiBold", 15, 'italic'),
                                  background='#BBD0FF')
        ...
        info_frame = LabelFrame(admin_supplier_page, text="Supplier Info", font=("Poppins SemiBold", 15, 'italic'),
                                background='#BBD0FF')
        ...
        # Add Buttons
        button_frame = LabelFrame(admin_supplier_page, text="Commands", font=("Poppins SemiBold", 15, 'italic'),
                                  background='#BBD0FF')
